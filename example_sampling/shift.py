...
if __name__ == '__main__':
    ...
    # skin
    ckpt = 'logs/2024-03-30_00-10-17_histo-ldm-kl-8-512-shift/checkpoints/last.ckpt'
    # ckpt = '/data/histo_diffusion_augmentation/diffusion_model.ckpt'

    # shift
    # ckpt = '/data/histo_diffusion_augmentation/if2HE_adapter.ckpt'

    config = OmegaConf.load('configs/latent-diffusion/histo-ldm-kl-8-512-shift.yaml')
    device = 'cuda:3'
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_dataloader):
            ...
            combined.save(f'imgs/shift/combined_{i}_{seed}.png')
            print(f'imgs/shift/combined_{i}_{seed}.png saved!')
