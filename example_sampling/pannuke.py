...
pl_sd = torch.load('/gpuhome/jxy225/HistoDiffAug/saved_classifier_train_subsets_skin_0417/model_000100.pt', map_location="cpu")
# classifier.load_state_dict(pl_sd, strict=False)
classifier.eval()
...
if __name__ == '__main__':
    ...
    val_dataset = VirtualStainingDataset(dataset='pannuke',
                                         mode='test')
    ...
    # skin
    # ckpt = 'logs/2024-04-03_05-39-44_histo-ldm-kl-8-512-skin/diffusion_385_91000.ckpt'

    config = OmegaConf.load('configs/latent-diffusion/histo-ldm-kl-8-512-pannuke.yaml')
    device = 'cuda:4'
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_dataloader):
            ...
            combined.save(f'imgs/pannuke_0423/combined_{i}_{seed}.png')
            print(f'imgs/pannuke_0423/combined_{i}_{seed}.png saved!')
