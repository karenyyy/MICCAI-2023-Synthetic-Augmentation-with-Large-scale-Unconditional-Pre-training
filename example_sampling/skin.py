...
if __name__ == '__main__':
    ...
    val_dataset = VirtualStainingDataset(dataset='skin',
                                         mode='test')
    ...
    config = OmegaConf.load('configs/latent-diffusion/histo-ldm-kl-8-512-skin.yaml')
    device = 'cuda:7'
    ...
    pl_sd = torch.load('/gpuhome/jxy225/HistoDiffAug/saved_classifier_train_subsets/model_000100.pt', map_location="cpu")
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_dataloader):
            ...
            combined.save(f'imgs/skin_0423/combined_2_{i}_{seed}.png')
            print(f'imgs/skin_0423/combined_2_{i}_{seed}.png saved!')
